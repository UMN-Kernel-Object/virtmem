...
void print_map_entry(map_entry_t m, char *prefix){
  ...
  if(m.present.present){
    printf("present  ");
    printf("pfn: %lx  ",m.present.pfn);
  }
  else if(m.present.swapped){
    printf("swapped  ");
    printf("swaptyp: %lx  ",m.swapped.swaptyp);
    printf("swapoff: %lx  ",m.swapped.swapoff);
  }
  if(m.present.present || m.present.swapped){
    printf("dirty: %d  ",m.present.dirty);
    printf("exclu: %d  ",m.present.exclu);
    printf("wprot: %d  ",m.present.wprot);
    printf("isfile: %d  ",m.present.isfile);
  }
  printf("\n");
}
